...
export default defineConfig({
  ...
  locales: {
    root: {
        ...
        themeConfig: {
            ...
            nav: [
              { text: 'Main Page', link: '/' },
              { text: 'Development', link: '/devGuide' }
            ],
            ...
            sidebar: [
              ...
              }, 
              {
                ...
                collapsed: false,
                items: [
                  { text: 'Development Guide', link: '/devGuide' },
                ],
              }, 
            ],
        
            socialLinks: [
              { icon: 'github', link: 'https://github.com/Vincent-the-gamer/vitefest' },
            ],
            ...
            footer: {
              message: `Version: v${config.version} | MIT Licensed`,
              copyright: 'Copyright ©2023-present Vincent-the-gamer（诡锋）'
            },
    ...
    zh_hans: {
        ...
        themeConfig: {
            ...
            sidebar: [
              {
                ...
                collapsed: false,
                items: [
                  { text: '使用说明书', link: '/zh_hans/userManual' },
                ],
              }, 
              {
                text: '开发',
                collapsed: false,
                items: [
                  { text: '开发指南', link: '/zh_hans/devGuide' },
                ],
              }, 
            ],
            ...
            footer: {
              message: `版本: v${config.version} | MIT Licensed`,
              copyright: '版权所有 ©2023-present Vincent-the-gamer（诡锋）'
            },
  ...
  head: [
    // 添加图标
    ['link', { rel: 'icon', href: '/logo/vitefest.png' }],
  ],
  themeConfig: {
    // 搜索
    search: {
